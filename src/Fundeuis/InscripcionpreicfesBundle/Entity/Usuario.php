 ...
 * @ORM\Entity(repositoryClass="Fundeuis\InscripcionpreicfesBundle\Entity\UsuarioRepository")
 */
class Usuario
{
    /**
     ...
     * Set user
     *
     * @param \Fundeuis\InscripcionpreicfesBundle\Entity\User $user
     * @return Usuario
     */
    public function setUser(\Fundeuis\InscripcionpreicfesBundle\Entity\User $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \Fundeuis\InscripcionpreicfesBundle\Entity\User 
     */
     ...
     * Set ciudad
     *
     * @param \Fundeuis\InscripcionpreicfesBundle\Entity\Ciudad $ciudad
     * @return Usuario
     */
    public function setCiudad(\Fundeuis\InscripcionpreicfesBundle\Entity\Ciudad $ciudad = null)
    {
        $this->ciudad = $ciudad;
     ...
     * Get ciudad
     *
     * @return \Fundeuis\InscripcionpreicfesBundle\Entity\Ciudad 
     */
     ...
     *
     * @param \Fundeuis\InscripcionpreicfesBundle\Entity\Tipodocumentoidentidad $tipodocumentoidentidad
     * @return Usuario
     */
    public function setTipodocumentoidentidad(\Fundeuis\InscripcionpreicfesBundle\Entity\Tipodocumentoidentidad $tipodocumentoidentidad = null)
    {
     ...
     *
     * @return \Fundeuis\InscripcionpreicfesBundle\Entity\Tipodocumentoidentidad 
     */
