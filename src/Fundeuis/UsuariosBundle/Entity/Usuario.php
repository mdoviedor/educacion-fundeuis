...
class Usuario
{
     ...
     * Set user
     *
     * @param \Fundeuis\UsuariosBundle\Entity\User $user
     * @return Usuario
     */
    public function setUser(\Fundeuis\UsuariosBundle\Entity\User $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \Fundeuis\UsuariosBundle\Entity\User 
     */
     ...
     * Set ciudad
     *
     * @param \Fundeuis\UsuariosBundle\Entity\Ciudad $ciudad
     * @return Usuario
     */
    public function setCiudad(\Fundeuis\UsuariosBundle\Entity\Ciudad $ciudad = null)
    {
        $this->ciudad = $ciudad;
     ...
     * Get ciudad
     *
     * @return \Fundeuis\UsuariosBundle\Entity\Ciudad 
     */
     ...
     *
     * @param \Fundeuis\UsuariosBundle\Entity\Tipodocumentoidentidad $tipodocumentoidentidad
     * @return Usuario
     */
    public function setTipodocumentoidentidad(\Fundeuis\UsuariosBundle\Entity\Tipodocumentoidentidad $tipodocumentoidentidad = null)
    {
     ...
     *
     * @return \Fundeuis\UsuariosBundle\Entity\Tipodocumentoidentidad 
     */
