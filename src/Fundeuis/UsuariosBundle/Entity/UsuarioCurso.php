...
class UsuarioCurso
{
     ...
     * Set curso
     *
     * @param \Fundeuis\UsuariosBundle\Entity\Curso $curso
     * @return UsuarioCurso
     */
    public function setCurso(\Fundeuis\UsuariosBundle\Entity\Curso $curso = null)
    {
        $this->curso = $curso;
     ...
     * Get curso
     *
     * @return \Fundeuis\UsuariosBundle\Entity\Curso 
     */
